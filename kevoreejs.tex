...
This section present a module system for the JavaScript programming language called KevoreeJS . KevoreeJS implements a dynamic component model for SPA. This component model currently addresses only a part of the challenges discusses in Section 2.   
