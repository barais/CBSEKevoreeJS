...
\ff{somehow, Analytics and brower history are clearly more a challenge due to dynamic SPA rather than the CBSE architecture itself. Maybe we should make this more obvious because here this requires undertanding to slit them. A simple solution whould be merge them with an introduction sentence to clarify this link}
